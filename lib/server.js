...
module.exports.setCurrentBuildLog = function (buildLog) {
    ...
    _io.emit('currentBuildLogUpdated', buildLog);
}
...
module.exports.setPreviousBuildLog = function (buildLog) {
    ...
    _io.emit('previousBuildLogUpdated', buildLog, _previousBuildLog);
}
...
var _addIoReceivers = function() {
    ...
    _io.on('connection', function(socket){
        ...
        socket.emit('statusUpdated', _statusMessage);
        socket.emit('currentBuildLogUpdated', _currentBuildLog);
        socket.emit('previousBuildLogUpdated', _previousBuildLog);
        socket.emit('buildResultUpdated', _buildResult);
    });
};
